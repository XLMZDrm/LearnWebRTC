!(function () {
	...
	(r = {
		...
		(m.prototype.pack_object = function (e) {
			...
			for (var r in e)
				e.hasOwnProperty(r) && (this.pack(r), this.pack(e[r]));
		}),
		...
		if (e.RTCPeerConnection) {
			...
			e.RTCPeerConnection.prototype.setLocalDescription = function () {
				return arguments.length && arguments[0].type
					? ((arguments[0] = n(this, arguments[0])),
				...
				for (var o = 0; o < t.codecs.length; o++) {
					...
					if (
						...
						if (
							...
							continue;
						((a = JSON.parse(JSON.stringify(a))).numChannels =
							Math.min(n.numChannels, a.numChannels)),
							r.codecs.push(a),
							(a.rtcpFeedback = a.rtcpFeedback.filter(function (
								e,
							) {
								for (var t = 0; t < n.rtcpFeedback.length; t++)
									if (
										n.rtcpFeedback[t].type === e.type &&
										n.rtcpFeedback[t].parameter ===
											e.parameter
									)
										return !0;
								return !1;
			...
			return (
				e &&
					...
					((e.iceServers =
						...
						r.version,
						(n = !1),
						(t = JSON.parse(JSON.stringify(t))).filter(function (
							e,
						) {
							if (e && (e.urls || e.url)) {
								var t = e.urls || e.url;
	...
	(H.generateIdentifier = function () {
		...
		(H.writeMediaSection = function (e, t, r, n) {
			...
			if (
				...
				(i += 'a=' + o),
					(i +=
						'a=ssrc:' + e.sendEncodingParameters[0].ssrc + ' ' + o),
					e.sendEncodingParameters[0].rtx &&
						((i +=
							'a=ssrc:' +
							e.sendEncodingParameters[0].rtx.ssrc +
			...
			Object.defineProperty(i.prototype, 'localDescription', {
					...
					return (
						...
						(this.transceivers[t].bufferCandidates = function (e) {
							...
							(i.state = r ? 'completed' : 'gathering'),
								null !==
									n.transceivers[t].bufferedCandidateEvents &&
									n.transceivers[
										t
							...
							(i.onlocalcandidate = function (e) {
								if (!(n.usingBundle && r > 0)) {
									...
									'gathering' !== n.iceGatheringState &&
										...
										s ||
											n._dispatchEvent('icecandidate', o),
										d &&
											(n._dispatchEvent(
												'icecandidate',
						...
						t.forEach(function (e, t) {
							...
							if (
								!(
									W.isRejected(e) &&
									0 ===
										W.matchPrefix(e, 'a=bundle-only').length
								) &&
								!o.rejected
							) {
				...
				(i.prototype.setRemoteDescription = function (i) {
					...
					return (
						(o.canTrickleIceCandidates =
							!!l &&
							l.substr(14).split(' ').indexOf('trickle') >= 0),
						c.forEach(function (n, c) {
							...
							if (
								...
								!h &&
									...
									(o.transceivers[c] = o._createTransceiver(
										f,
										!0,
									));
								var E,
								...
								h ||
									...
									((x = W.getDtlsParameters(n, p)).role =
										'client')),
								...
								if (
									...
									if ('answer' === i.type && !h) {
										(C = (b = o.transceivers[c])
											...
											(o.transceivers[c].rtcpParameters =
												O),
											M.length &&
												'new' === _.state &&
												((!d && !I) || (u && 0 !== c)
									...
									((b =
										o.transceivers[c] ||
										o._createTransceiver(f)).mid = g),
										b.iceGatherer ||
											(b.iceGatherer =
												o._createIceGatherer(c, u)),
										M.length &&
				...
				(i.prototype.createOffer = function () {
					...
					r.transceivers.forEach(function (n, i) {
						...
						(n.mid = s),
							n.iceGatherer ||
								(n.iceGatherer = r._createIceGatherer(
									i,
									r.usingBundle,
								));
							...
							c.codecs.forEach(function (e) {
								'H264' === e.name &&
									...
									n.remoteCapabilities &&
										...
										n.remoteCapabilities.codecs.forEach(
											function (t) {
												e.name.toLowerCase() ===
													t.name.toLowerCase() &&
													e.clockRate ===
						...
						: new Promise(function (n, i) {
								...
								if (e && '' !== e.candidate) {
									...
									if (e.sdpMid)
										for (
											var a = 0;
											a < r.transceivers.length;
											a++
										)
											if (
												r.transceivers[a].mid ===
												e.sdpMid
											) {
												o = a;
												break;
									...
									0 === p.indexOf('a=') && (p = p.substr(2)),
										((t = W.getMediaSections(
											r._remoteDescription.sdp,
										))[o] +=
											'a=' +
											(c.type ? p : 'end-of-candidates') +
											'\r\n'),
										(r._remoteDescription.sdp =
											W.getDescription(
												r._remoteDescription.sdp,
						...
						return (
							n &&
								n.forEach(function (e) {
									o._localStreams
										? o._localStreams.includes(e) ||
										  o._localStreams.push(e)
										: (o._localStreams = [e]);
								}),
							t.apply(this, arguments)
						);
				...
				if (e && e.iceServers) {
					for (var n = [], i = 0; i < e.iceServers.length; i++) {
						...
						!o.hasOwnProperty('urls') && o.hasOwnProperty('url')
							? (k('RTCIceServer.url', 'RTCIceServer.urls'),
							  ((o = JSON.parse(JSON.stringify(o))).urls =
									o.url),
							  delete o.url,
							  n.push(o))
	...
	Object.create &&
		...
		(Ye.prototype.emit = function (e, t, r, n, i, o) {
			...
			if (p.fn) {
				switch (
					(p.once && this.removeListener(e, p.fn, void 0, !0), d)
				) {
					case 1:
				...
				for (c = 0; c < l; c++)
					switch (
						(p[c].once &&
							this.removeListener(e, p[c].fn, void 0, !0),
						d)
					) {
						case 1:
	...
	var dt,
		...
		mt = (function (e) {
			var t = function (t, r, n, i, o, a) {
				...
				var c = t ? 'wss://' : 'ws://';
				return (
					(s._baseUrl = c + r + ':' + n + i + 'peerjs?key=' + o), s
				);
			};
			return (
				ut(t, e),
					...
					qe.default.log('Listening for ICE candidates.'),
						(e.onicecandidate = function (e) {
							e.candidate &&
								e.candidate.candidate &&
								(qe.default.log(
									'Received ICE candidates for '.concat(
										r,
										':',
									),
									e.candidate,
							...
							switch (s.label) {
								...
								case 2:
									return (
										s.sent(),
										qe.default.log(
											'Added ICE candidate for:'.concat(
		...
		Et = (function (e) {
			function t(r, n, i) {
				...
				return (
					...
					(o.connectionId =
						o.options.connectionId ||
						t.ID_PREFIX + Fe.randomToken()),
				...
				return (
					...
					o._options.path &&
						...
						'/' !== o._options.path[o._options.path.length - 1] &&
							(o._options.path += '/')),
					void 0 === o._options.secure &&
					o._options.host !== Fe.CLOUD_HOST
			...
			return (
				...
				(t.prototype._handleMessage = function (e) {
					...
					switch (n) {
						...
						case ot.Leave:
							qe.default.log(
								'Received leave message from '.concat(o),
							),
								this._cleanupPeer(o),
						...
						case ot.Offer:
							...
							if (
								((f = this.getConnection(o, a)) &&
									(f.close(),
									qe.default.warn(
										'Offer received for existing Connection ID:'.concat(
											a,
										),
									)),
								i.type === tt.Media)
								...
								if (i.type !== tt.Data)
									return void qe.default.warn(
										'Received malformed connection type:'.concat(
											i.type,
										),
									);
				...
				(t.prototype.emitError = function (e, t) {
					...
					qe.default.error('Error:', t),
						((r = 'string' == typeof t ? new Error(t) : t).type =
							e),
						this.emit('error', r);
				}),
				(t.prototype.destroy = function () {
					this.destroyed ||
						(qe.default.log(
							'Destroy peer with ID:'.concat(this.id),
						),
						this.disconnect(),
						this._cleanup(),
						(this._destroyed = !0),
